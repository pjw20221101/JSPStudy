...
<table width = "500" border="1"> 
	...
	<tr> 
		...
		<td><a href="read01.jsp?idx=<%=keyid.elementAt(j) %>&page=<%= where %>"> <%=email.elementAt(j) %></a> </td> 
...
<%
 ...
 <FORM method="post" name="search" action="search01.jsp">
<TABLE border=0 width=600 cellpadding=0 cellspacing=0>
 <TR>
  ...
  <TD>&nbsp;<a href="#" onClick="check();">검색</A></TD>
  <TD><A href="Insert01.jsp">글쓰기</A></TD>
 </TR>
</TABLE>
</FORM>
