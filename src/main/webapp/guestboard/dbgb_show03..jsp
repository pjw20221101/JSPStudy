...
<%
	// 컬렉션 : 방의 크기를 자동으로 늘려 준다.
		...
		//    동일안 메소드르 사용 
	ArrayList name = new ArrayList(); 	//DB 테이블에서 name 컬럼의 값만 담는 변수 
...
<div> 
	<table width="600px" border = "1px"> 
		...
		<tr> 
			<td> 글쓴이 :  <%= name.get(i) %></td> 
			<td> E-Mail : <%= email.get(i) %> </td>
		</tr>
		<tr> 
			<td colspan ="2"> 글쓴날짜 : <%= inputdate.get(i) %> </td> 
		</tr>
		<tr> 
			<td colspan ="2" width="600px"><%= content.get(i) %>  </td> 
		</tr>
